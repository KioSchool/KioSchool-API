...
data class WorkspaceAdminDetailDto(
    ...
    val members: List<WorkspaceUserSummaryDto>,
    ...
    companion object {
        fun of(workspace: Workspace): WorkspaceAdminDetailDto {
            return WorkspaceAdminDetailDto(
                ...
                ownerLoginId = workspace.owner.loginId,
                members = workspace.members.map { WorkspaceUserSummaryDto.of(it.user) }.sortedBy { it.id },
